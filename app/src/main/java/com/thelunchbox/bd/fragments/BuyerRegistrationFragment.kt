...
class BuyerRegistrationFragment : Fragment(),RegistrationView {
    private var _binding: FragmentBuyerRegistrationBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBuyerRegistrationBinding.inflate(inflater, container, false)
